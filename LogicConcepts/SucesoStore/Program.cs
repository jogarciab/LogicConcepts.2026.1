...
do
{
    ...
    var CC = ConsoleExtension.GetDecimal("Costo de la compra ($).........................................................:");
    ...
    var CE = GetCostoExibicion(TP, TC, MA, CA);
...
decimal GetCostoExibicion(string? TP, string? TC, string? MA, decimal CA)
{
    if (TP!.Equals("p", StringComparison.CurrentCultureIgnoreCase))
    {
